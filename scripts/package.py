...
def update_manifest(version: str, changelog: str, timestamp: str, checksum: str) -> None:
    ...
    entry = {
        ...
        "changelog": changelog,
        "targetAbi": TARGET_ABI,
        "sourceUrl": f"{REPO_URL}/releases/download/v{version}/watchnotify_{version}.zip",
        "checksum": checksum,
        "timestamp": timestamp,
    }
...
def main() -> None:
    ...
    if args.manifest:
        update_manifest(version, args.changelog, timestamp, checksum)
